...
class TransaksiController extends Controller
{
    ...
    public function list(Request $request) {
        ...
        ->addColumn('aksi', function ($trx) {
            $btn = '<a href="'.url('/transaksi/' . $trx->penjualan_id).'" class="btn btn-info btn-sm">Detail</a> ';
            $btn .= '<a href="' . url('/transaksi/' . $trx->penjualan_id . '/edit' ) . '" class="btn btn-warning btn-sm">Edit</a> ';
            $btn .= '<form class="d-inline-block" method="POST" action="'. url('/transaksi/'.$trx->penjualan_id).'">'.
    ...
    public function show(string $id) {
        $trans = TransaksiModel::with(['user'])->find($id);
        ...
        return view('transaksi.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'trans' => $trans, 'details' => $details, 'number' => $number, 'activeMenu' => $activeMenu]);
    }
    ...
    public function create() {
        ...
        $users = UserModel::all(); 
        $activeMenu = 'transaksi'; 
        return view('transaksi.create', ['breadcrumb' => $breadcrumb, 'page' => $page, 'items' => $items, 'users' => $users, 'activeMenu' => $activeMenu]);
    }
    ...
    public function edit(string $id) {
        ...
        return view('transaksi.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'trans' => $trans, 'details' => $details, 'items' => $items, 'users' => $users, 'activeMenu' => $activeMenu]);
    }
