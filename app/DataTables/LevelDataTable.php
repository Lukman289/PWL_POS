    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($user) {
                return 
                    '<a href="' . route('/kategori/edit', ['id' => $user->level_id]) . '" class="btn btn-primary mr-2">
                    <i class="fa fa-pencil-alt" style="color: white; font-size: 12px;"></i></a>' .
                    '<a href="' . route('/kategori/hapus', ['id' => $user->level_id]) . '" class="btn btn-danger" onclick="return confirm(\'Lanjutkan Menghapus Data?\')">
